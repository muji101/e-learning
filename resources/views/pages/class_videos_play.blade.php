...
<head>
    ...
    <title>GoSinau | {{ $video ? $videos->title : '' }}</title>
...
<body>
    ...
    <div class="flex-reverse md:flex">
        ...
        <div class="flex-grow bg-gray-600">
            <div class="sticky top-0 h-60  md:mx-8 md:pt-4 md:pb-14 md:h-screen">
                @if ($link)
            ...
            <div class="sticky bottom-0 md:mt-10 px-12 text-gray-100 hidden md:block">
